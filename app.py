...
pickle_in = open("mid_term_nikhil.pkl","rb")
...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: NIKHIL GUPTA</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;"> PIET18CS100 -- Sec: B -- Roll No 43 </p></center>
   </div>
   </div>
   </div>
   """
